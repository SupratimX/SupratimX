...
<p>
  ...
  <a href="https://www.instagram.com/supratim_spx">
...
| -- | ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| 🔹 | **[ISEA-Phase3-TezpurUniversity-ComputerNetwork](https://github.com/SupratimX/ISEA-Phase3-TezpurUniversity-ComputerNetwork)** | Internship project and work related to computer networking, concepts, practical implementation and learning.               | `Computer Networks`              |
